...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.CustomViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        context_name = context.toString().substring(0,idx);
        Log.d("context",""+context_name);
        if(context_name.equals(MainActivity.class.getName())){
            if(arrayList.get(position).getLocation().length() > 10){
...
//                    Log.d("MainActivity",""+holder.writer_id);
